...
train_path = "/local/scratch/v_sabhay_jain/training_3d_resnet/finetuning/global_data/train_exp_split.csv"
val_path = "/local/scratch/v_sabhay_jain/training_3d_resnet/finetuning/global_data/val_exp_split.csv"
test_path = "/local/scratch/v_sabhay_jain/training_3d_resnet/finetuning/global_data/test_exp_split.csv"
